...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add') {
        ...
        $query = "INSERT INTO chapters (chapter) VALUES (?)";
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, 's', $chapter);
        ...
        $query = "UPDATE chapters SET chapter = ? WHERE id = ?";
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, 'si', $chapter, $chapterId);
        mysqli_stmt_execute($stmt);
...
<header>
        ...
        <p><?php echo "Welcome" ." ".$_SESSION['username'] ." you are  ". "$role"; ?> 
                ...
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($result1)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                    <input type="hidden" name="chapter_id" value="<?php echo $row['id']; ?>">
